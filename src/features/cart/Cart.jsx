...
const Cart = () => {
  ...
  const handlePayNow = async () => {
    ...
    try {
      ...
      // Import Cashfree from the loaded SDK
      const { Cashfree } = await load({ mode: "production" });

      // Initialize checkout with proper configuration
      const checkoutOptions = {
        paymentSessionId: paymentSessionId,
        redirectTarget: "_self", // Changed from element to _self for proper redirect
        returnUrl: `https://onrise.in/order-success?order_id={order_id}`, // Fixed: removed template literal
      };

      // For drop-in mode (if you want embedded checkout)
      // Uncomment this and comment the redirect approach above if needed
      /*
      const checkoutOptions = {
        paymentSessionId: paymentSessionId,
        redirectTarget: document.getElementById("cashfree-dropin"),
